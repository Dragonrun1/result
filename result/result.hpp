...
namespace result {
    ...
    constexpr bool operator==(unit_t, unit_t) {
        return true;
    }
    ...
    public:
        ...
        [[nodiscard]] constexpr unit_t value() const {
            return {};
        }
    };
    ...
    public:
        ...
        constexpr Result(const Result &other) noexcept(
            std::is_nothrow_copy_constructible_v<
                details::ResultStorage<T, E> >) = default;
        ...
        template<typename F,
            ...
            std::enable_if_t<std::is_invocable_r_v<Result<T2, E>, F, T>,
                int>  = 0>
        ...
        template<typename F,
            ...
            std::enable_if_t<std::is_invocable_r_v<Result<T, E2>, F, E>,
                int>  = 0>
